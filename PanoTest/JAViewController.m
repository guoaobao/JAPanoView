...
- (void)loadView {
    ...
    /*[panoView setFrontVideo:[[NSBundle mainBundle] URLForResource:@"output_5" withExtension:@"mp4"]
                ...
                bottomVideo:nil];*/
    [panoView setFrontVideo:[[NSBundle mainBundle] URLForResource:@"output_5" withExtension:@"mp4"]
                 rightVideo:[[NSBundle mainBundle] URLForResource:@"output_1" withExtension:@"mp4"]
                  backVideo:[[NSBundle mainBundle] URLForResource:@"output_6" withExtension:@"mp4"]
                  leftVideo:[[NSBundle mainBundle] URLForResource:@"output_2" withExtension:@"mp4"]
                   topVideo:[[NSBundle mainBundle] URLForResource:@"output_3" withExtension:@"mp4"]
                bottomVideo:[[NSBundle mainBundle] URLForResource:@"output_4" withExtension:@"mp4"]];
